...
export namespace OneKeyConnect {
    ...
    function ConfluxSignMessageCIP23<T extends Conflux.MessageTypes>(params: P.CommonParams & Conflux.ConfluxSignMessageEIP712<T>): P.Response<Protobuf.ConfluxMessageSignature>;
